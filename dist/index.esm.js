...
var ModalBlockChain = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Choose your blockchain", onDismiss: onDismiss },
        ...
        React.createElement(Button, { width: "100%", variant: "tertiary", onClick: function () { window.location.href = 'https://app.rsk.tea-swap.finance/'; }, style: { justifyContent: "space-between" }, mb: 10 },
